...
public class MyBuyBoardInformFinish extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_buy_board_inform_finish);
        ...
        public void onClick(View v) {
            switch(v.getId()){
                case R.id.btn_delete:
                    AlertDialog.Builder alert_confirm = new AlertDialog.Builder(MyBuyBoardInformFinish.this);
