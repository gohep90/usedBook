...
public class SellBoardInform extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sell_board_inform);
        ...
        Log.i("Thisis", String.valueOf(index));
    ...
    public void onBackPressed(){
        Toast.makeText(SellBoardInform.this, "피니시한다.", Toast.LENGTH_SHORT).show();
        finish();
    }
